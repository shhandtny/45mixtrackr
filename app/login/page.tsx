  ...
  return (
    <PageShell>
      <div className="max-w-sm mx-auto mt-8">
        ...
        <p className="text-[#B3B3B3] text-sm mb-8">Welcome back to 45 Mix Trackr</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-spotify-green hover:bg-[#FB923C] text-black font-bold py-3 rounded-full transition-colors disabled:opacity-40"
          >
        ...
        <p className="text-[#B3B3B3] text-sm mt-6 text-center">
          No account?{' '}
          <Link href="/signup" className="text-spotify-green hover:underline font-semibold">
            Sign up free
          </Link>
        </p>
      </div>
